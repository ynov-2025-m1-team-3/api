...
const analyzer = new natural.SentimentAnalyzer("French", natural.PorterStemmer, "pattern");

// Dictionnaire de mots positifs et négatifs en français
const frenchLexicon = {
  positifs: [
    "excellent", "excellente", "parfait", "parfaite", "bon", "bonne", "super", 
    "génial", "incroyable", "efficace", "réactif", "réactive", "agréable", 
    "satisfait", "satisfaite", "rapide", "fiable", "utile", "pratique", "aime",
    "adore", "apprécie", "recommande", "facile", "clair", "claire", "performant"
  ],
  négatifs: [
    "mauvais", "mauvaise", "horrible", "terrible", "décevant", "décevante", 
    "problème", "bug", "erreur", "lent", "lente", "cher", "chère", "coûteux", 
    "difficile", "compliqué", "compliquée", "inutile", "manque", "défaut", 
    "insuffisant", "insuffisante", "déçu", "déçue", "déteste", "pénible"
  ],
  négations: [
    "pas", "ne", "plus", "sans", "aucun", "aucune", "jamais", "ni"
  ],
  intensificateurs: [
    "très", "trop", "extrêmement", "vraiment", "totalement", "complètement", "particulièrement"
  ]
};
...
function analyzeTextSentiment(text) {
  ...
  for (let i = 0; i < tokens.length; i++) {
    ...
    if (frenchLexicon.intensificateurs.includes(token) && i < tokens.length - 1) {
